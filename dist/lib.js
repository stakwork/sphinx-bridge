...
(function (MSG_TYPE) {
    ...
    MSG_TYPE["GETTRIBETOKEN"] = "GETTRIBETOKEN";
...
var Sphinx = /** @class */ (function () {
    ...
    Sphinx.prototype.getPersonData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var r, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.postMsg(MSG_TYPE.GETPERSONDATA)];
                    case 2:
                        r = _a.sent();
                        return [2 /*return*/, r];
                    case 3:
    ...
    Sphinx.prototype.getTribeToken = function () {
        return __awaiter(this, void 0, void 0, function () {
            var r, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.logging)
                            console.log("=> GETTRIBETOKEN");
                        if (!this.isEnabled)
                            return [2 /*return*/, null];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.postMsg(MSG_TYPE.GETTRIBETOKEN)];
                    case 2:
                        r = _a.sent();
                        return [2 /*return*/, r];
                    case 3:
